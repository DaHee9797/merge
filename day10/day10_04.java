...
public class day10_04 {
        ...
        a청둥오리.날다(); // 청둥오리가 기본 날개로 천천히 날아갑니다.
...
class 오리 {
    protected 날개 날개아이템; // private : class 내부에서만 가능하고 다른 곳에선 다 안되거든
    //protected : 상속관계에선 사용가능 하지만 다른곳에선 안됨0
...
class 청둥오리 extends 오리 {
    청둥오리() {
        ...
        System.out.println("청둥오리가 만들어집니다. 천둥오리는 기본 날개를 가지고 태어납니다.");
    }
}
...
class 날개 {
    public void 사용() {
        System.out.println("기본 날개로 천천히 날아갑니다.");
    }
}
